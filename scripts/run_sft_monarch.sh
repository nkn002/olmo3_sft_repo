...
RUN_NAME=olmo3-7b-instruct-sft-repro-monrch2
SESSION="$RUN_NAME"
WORK="$ROOT/repro/$RUN_NAME"
SFT_DATA_MONRCH2=/home/jovyan/gpus-4-nodes-volume/vy/data_editing/results/data_formated_Monrch2
